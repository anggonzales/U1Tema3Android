...
import com.example.u1tema3android.Ejemplo3.detalle_correo;
...
public class AdapterCorreoFragment extends RecyclerView.Adapter<AdapterCorreoFragment.ViewHolder> {
    ...
    public AdapterCorreoFragment.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = inflador.inflate(R.layout.activity_lis_item_correo, parent, false);
    ...
    public void onBindViewHolder(AdapterCorreoFragment.ViewHolder holder, final int i) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(micontext, detalle_correo.class);
                ...
                if (hayDetalle) {
                    ((MainFragmentCorreo) micontext).mostrarDetalle(datos[i].getTexto(),datos[i].getDe(),datos[i].getAsunto());
                } else {
